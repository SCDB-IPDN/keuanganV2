$(document).ready(function() {
    ...
    if ($('#tbl-scdb-dosen-dikti').length !== 0) {
        ...
        // Untuk sunting
        $('#editdosendikti').on('show.bs.modal', function (event) {
            var div = $(event.relatedTarget) // Tombol dimana modal di tampilkan
            var modal          = $(this)
            ...
            modal.find('#status_aktifx').attr("value",div.data('status_aktif')); 
            ...
            modal.find('#status_pegawaix').attr("value",div.data('status_pegawai')); 
            ...
            modal.find('#status_pernikahanx').attr("value",div.data('status_pernikahan')); 
            ...
            modal.find('#mampu_menghandle_kebutuhan_khususx').attr("value",div.data('mampu_menghandle_kebutuhan_khusus')); 
            modal.find('#mampu_menghandle_brailex').attr("value",div.data('mampu_menghandle_braile')); 
            modal.find('#mampu_menghandle_bahasa_isyaratx').attr("value",div.data('mampu_menghandle_bahasa_isyarat')); 
            modal.find('#sertifikasi_dosenx').attr("value",div.data('sertifikasi_dosen')); 
            modal.find('#bidang_ilmux').attr("value",div.data('bidang_ilmu')); 
            modal.find('#jabatanx').attr("value",div.data('jabatan')); 
            ...
            modal.find('#judul_penelitianx').attr("value",div.data('judul_penelitian')); 
            modal.find('#lembagax').attr("value",div.data('lembaga')); 
            modal.find('#tahun_penelitianx').attr("value",div.data('tahun_penelitian')); 

        });

        $('#hapusdosendikti').on('show.bs.modal', function (event) {
            var div = $(event.relatedTarget) // Tombol dimana modal di tampilkan
            var modal          = $(this)
