<div id="content" class="content">
	<ol class="breadcrumb float-xl-right">
		...
		<li class="breadcrumb-item"><a href="<?= base_url('frontend/d_frontend/laman_link');?>">Laman Link</a></li>
	</ol>
	<h1 class="page-header">Data Laman Link</h1>
	<div class="row">
		<div class="col-xl-12">
			<div class="panel panel-inverse">
				...
				<div class="alert alert-warning fade show">
					...
					<p>Silahkan input <b>Data Laman Link</b> Pada Button icon "<i class="fa fa-plus-square"></i>"</p>
				</div>
							...
							foreach($data as $row){
								...
								<tr align="center">
									...
									<td>
										...
										<a href="<?= base_url('frontend/d_frontend/hide_l/'.$row->id);?>" class="btn btn-sm btn-danger" style="color:#fff;cursor:pointer"><i class="fa fas fa-eye-slash"></i> Hide</a>
									...
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											<div class="modal-header">
												<h5 class="modal-title" id="exampleModalLabel">Edit Data Laman Link</h5>
											...
											<div class="modal-body">
												<form action="edit_link" method="POST">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="link" value="<?= $row->link;?>" placeholder="Link ..." required>
														<input type="hidden" name="id" value="<?= $row->id;?>">
													</div>
													<div class="form-group">
														<label class="col-form-label">Pending Time</label>
														<input type="text" class="form-control" name="pending" value="<?= $row->pending;?>" placeholder="Pending Time ..." required>
													</div>
								...
								<div class="modal fade" id="del-menu<?= $row->id;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											<div class="modal-header">
												<h5 class="modal-title" id="exampleModalLabel">Hapus Data Laman Link</h5>
												<button type="button" class="close" data-dismiss="modal" aria-label="Close">
													<span aria-hidden="true">&times;</span>
												</button>
											</div>
											<div class="modal-body">
												<form class="form-horizontal" method="post" action="del_link">
													<div class="modal-body">
														<p>Anda yakin mau menghapus Menu <b><?= $row->link;?></b>?</p>
													</div>
													<div class="modal-footer">
														<input type="hidden" name="id" value="<?= $row->id;?>">
	...
	<div class="modal fade" id="add-menu" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">Tambah Data Laman Link</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
				</div>
				<div class="modal-body">
					<form action="add_link" method="POST">
						...
						<div class="form-group">
							<label class="col-form-label">Pending Time</label>
							<input type="number" class="form-control"  name="pending" placeholder="Pending Time ..." required>
						</div>
						<div class="modal-footer">
							<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
