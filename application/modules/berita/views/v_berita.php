            ...
            <tbody>
                <?php $no = 0; foreach($data as $row){ $no++; ?>
                    <tr>
                        ...
                        <td><?= "<img class='thumb-image setpropileam' src='".base_url('assets/upload/image/'.$row->gambar)."' width='128px' height='128px'>" ?></td>
                    ...
                    <!-- Modal EDIT -->
                    <div class="modal fade bd-example-modal-lg" id="edit<?php echo $row->id_berita;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
