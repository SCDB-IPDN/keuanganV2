...
<div id="content" class="content">
  <ol class="breadcrumb float-xl-right">
    ...
    <li class="breadcrumb-item"><a href="javascript:;">POK JATINANGOR</a></li>
    <?php if(isset($page)) { ?>
      <?php if(strlen($page) == 4) { ?>
        <li class="breadcrumb-item"><a href="javascript:;"><?= $biro ?></a></li>
      <?php } else { ?>
        <li class="breadcrumb-item"><a href="javascript:;">BAGIAN/UNIT</a></li>
        <li class="breadcrumb-item"><a href="javascript:;">OUTPUT</a></li>
      <?php } ?>
    <?php } ?>
  </ol>
