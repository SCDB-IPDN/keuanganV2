...
<div id="content" class="content">
	...
	<div class="row">
			...
			<div class="panel panel-inverse">
				<div class="panel-heading">
					<h4 class="panel-title">
						<span><a href="<?php echo base_url('d_praja/editstatus');?>" class="btn btn-sm btn-warning"> STATUS
								PRAJA</a></span>
		...
		<!-- Modal Ubah -->
		<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="show-data"
			class="modal fade">
									...
									<div role="tabpanel" class="tab-pane fade active show" id="profile">
										...
										<table class="table table-striped" cellspacing="0" align="center">
											<tbody>
												<tr>
													<td>NPP</td>
													<td><input type="text" readonly class="form-control-plaintext" id="npp" style="height:10px;">
													</td>
												</tr>
												<tr>
													<td>NAMA PRAJA</td>
													<td><input type="text" readonly class="form-control-plaintext" id="nama" style="height:10px;">
													</td>
												</tr>
												<tr>
													<td>JENIS KELAMIN</td>
													<td><input type="text" readonly class="form-control-plaintext" id="jk" style="height:10px; ">
													</td>
												</tr>
												<tr>
													<td>TEMPAT TANGGAL LAHIR</td>
													<td><input type="text" readonly class="form-control-plaintext" id="tmpt_lahir"
															style="height:10px; "></td>

												</tr>
												<tr>
													<td>NISN</td>
													<td><input type="text" readonly class="form-control-plaintext" id="nisn"
															style="height:10px; "></td>
												</tr>
												<tr>
													<td>NPWP</td>
													<td><input type="text" readonly class="form-control-plaintext" id="npwp"
															style="height:10px; "></td>
												</tr>
												<tr>
													<td>NO SPCP</td>
													<td><input type="text" readonly class="form-control-plaintext" id="no_spcp"
															style="height:10px; "></td>
												</tr>
												<tr>

													<td>NIK</td>
													<td><input type="text" readonly class="form-control-plaintext" id="nik_praja"
															style="height:10px; "></td>
												</tr>
												<tr>
													<td>AGAMA</td>
													<td> <input type="text" readonly class="form-control-plaintext" id="agama"
															style="height:10px; "></td>
												</tr>
												<tr>
													<td>ALAMAT</td>
													<td><input type="text" readonly class="form-control-plaintext" id="alamat"
															style="height:10px;"></td>
												</tr>
												<tr>
													<td>RT</td>
													<td><input type="text" readonly class="form-control-plaintext" id="rt" style="height:10px; ">
													</td>
												</tr>
												<tr>
													<td>RW</td>
													<td> <input type="text" readonly class="form-control-plaintext" id="rw" style="height:10px; ">
													</td>
												</tr>
												<tr>
													<td>NAMA DUSUN</td>
													<td> <input type="text" readonly class="form-control-plaintext" id="nama_dusun"
															style="height:10px; "></td>
												</tr>
												<tr>
													<td>KELURAHAN</td>
													<td> <input type="text" readonly class="form-control-plaintext" id="kelurahan"
															style="height:10px; "></td>
												</tr>
												<tr>
													<td>KECAMATAN</td>
													<td><input type="text" readonly class="form-control-plaintext" id="kecamatan"
															style="height:10px; "></td>
												</tr>
												<tr>
													<td>KODE POS</td>
													<td> <input type="text" readonly class="form-control-plaintext" id="kode_pos"
															style="height:10px; "></td>
												</tr>
												<tr>
													<td>JENIS TINGGAL</td>
													<td> <input type="text" readonly class="form-control-plaintext" id="jenis_tinggal"
															style="height:10px; "></td>
												</tr>
												<tr>
													<td>ALAT TRANSPORT</td>
													<td> <input type="text" readonly class="form-control-plaintext" id="alat_transport"
															style="height:10px; "></td>
												</tr>
												<tr>
													<td>TLP RUMAH</td>
													<td> <input type="text" readonly class="form-control-plaintext" id="tlp_rumah"
															style="height:10px; "></td>
												</tr>
												<tr>
													<td>NO HP</td>
													<td> <input type="text" readonly class="form-control-plaintext" id="tlp_pribadi"
															style="height:10px; "></td>
												</tr>
												<tr>
													<td>EMAIL</td>
													<td><input type="text" readonly class="form-control-plaintext" id="email"
															style="height:10px; "></td>
												</tr>
												<tr>
													<td>TINGKAT</td>
													<td><input type="text" readonly class="form-control-plaintext" id="tingkat"
															style="height:10px; "></td>
												</tr>
												<tr>
													<td>ANGKATAN</td>
													<td><input type="text" readonly class="form-control-plaintext" id="angkatan"
															style="height:10px; "></td>
												</tr>
												<tr>
													<td>STATUS</td>
													<td><input type="text" readonly class="form-control-plaintext" id="status"
															style="height:10px; "></td>
												</tr>
											</tbody>
										</table>
									...
									<div role="tabpanel" class="tab-pane fade" id="ortu">
										<table class="table table-striped">
											<tbody>
												<tr>
													<td>NIK AYAH</td>
													<td><input type="text" readonly class="form-control-plaintext" id="nik_ayah"
															style="height:10px; "></td>
												</tr>
												<tr>
													<td>NAMA AYAH</td>
													<td><input type="text" readonly class="form-control-plaintext" id="nama_ayah"
															style="height:10px; "></td>
												</tr>
												<tr>
													<td>TANGGAL LAHIR AYAH</td>
													<td><input type="text" readonly class="form-control-plaintext" id="tgllahir_ayah"
															style="height:10px; "></td>
												</tr>
												<tr>
													<td>PENDIDIKAN AYAH</td>
													<td><input type="text" readonly class="form-control-plaintext" id="pendidikan_ayah"
															style="height:10px; "></td>
												</tr>
												<tr>
													<td>PEKERJAAN AYAH</td>
													<td><input type="text" readonly class="form-control-plaintext" id="pekerjaan_ayah"
															style="height:10px; "></td>
												</tr>
												<tr>
													<td>PENGHASILAN AYAH</td>
													<td><input type="text" readonly class="form-control-plaintext" id="penghasilan_ayah"
															style="height:10px; "></td>
												</tr>
												<tr>
													<td>NIK IBU</td>
													<td><input type="text" readonly class="form-control-plaintext" id="nik_ibu"
															style="height:10px; "></td>
												</tr>
												<tr>
													<td>NAMA IBU</td>
													<td><input type="text" readonly class="form-control-plaintext" id="nama_ibu"
															style="height:10px; "></td>
												</tr>
												<tr>
													<td>TANGGAL LAHIR IBU</td>
													<td><input type="text" readonly class="form-control-plaintext" id="tgllahir_ibu"
															style="height:10px; "></td>
												</tr>
												<tr>
													<td>PENDIDIKAN IBU</td>
													<td><input type="text" readonly class="form-control-plaintext" id="pendidikan_ibu"
															style="height:10px; "></td>
												</tr>
												<tr>
													<td>PEKERJAAN IBU</td>
													<td><input type="text" readonly class="form-control-plaintext" id="pekerjaan_ibu"
															style="height:10px; "></td>
												</tr>
												<tr>
													<td>PENGHASILAN IBU</td>
													<td><input type="text" readonly class="form-control-plaintext" id="penghasilan_ibu"
															style="height:10px; "></td>
												</tr>
											</tbody>
										</table>
									...
									<div role="tabpanel" class="tab-pane fade" id="wali">
										<table class="table table-striped">
											<tbody>
												<tr>
													<td>NIK WALI</td>
													<td><input type="text" readonly class="form-control-plaintext" id="nik_wali"
															style="height:10px; "></td>
												</tr>
												<tr>
													<td>NAMA WALI</td>
													<td><input type="text" readonly class="form-control-plaintext" id="nama_wali"
															style="height:10px; "></td>
												</tr>
												<tr>
													<td>TANGGAL LAHIR WALI</td>
													<td><input type="text" readonly class="form-control-plaintext" id="tgllahir_wali"
															style="height:10px; "></td>
												</tr>
												<tr>
													<td>PENDIDIKAN WALI</td>
													<td><input type="text" readonly class="form-control-plaintext" id="pendidikan_wali"
															style="height:10px; "></td>
												</tr>
												<tr>
													<td>PEKERJAAN WALI</td>
													<td><input type="text" readonly class="form-control-plaintext" id="pekerjaan_wali"
															style="height:10px; "></td>
												</tr>
												<tr>
													<td>PENGHASILAN WALI</td>
													<td><input type="text" readonly class="form-control-plaintext" id="penghasilan_wali"
															style="height:10px; "></td>
												</tr>
									...
									<div role="tabpanel" class="tab-pane fade" id="lain">
										<table class="table table-striped">
											<tbody>
												<tr>
													<td>FAKULTAS</td>
													<td><input type="text" readonly class="form-control-plaintext" id="fakultas"
															style="height:10px; "></td>
												</tr>
												<tr>
													<td>PRODI</td>
													<td><input type="text" readonly class="form-control-plaintext" id="prodi"
															style="height:10px; "></td>
												</tr>
												<tr>
													<td>KEWARGANEGARAAN</td>
													<td><input type="text" readonly class="form-control-plaintext" id="kewarganegaraan"
															style="height:10px; "></td>
												</tr>
												<tr>
													<td>JENIS PENDAFTARAN</td>
													<td><input type="text" readonly class="form-control-plaintext" id="jenis_pendaftaran"
															style="height:10px; "></td>
												</tr>

												<tr>
													<td>TANGGAL MASUK KULIAH</td>
													<td><input type="text" readonly class="form-control-plaintext" id="tgl_masuk_kuliah"
															style="height:10px; "></td>
												</tr>
												<tr>
													<td>TAHUN MASUK KULIAH</td>
													<td><input type="text" readonly class="form-control-plaintext" id="tahun_masuk_kuliah"
															style="height:10px; "></td>
												</tr>
												<tr>
													<td>PEMBIAYAAN</td>
													<td><input type="text" readonly class="form-control-plaintext" id="pembiayaan"
															style="height:10px; "></td>
												</tr>
												<tr>
													<td>JALUR MASUK</td>
													<td><input type="text" readonly class="form-control-plaintext" id="jalur_masuk"
															style="height:10px; "></td>
												</tr>
											</tbody>
										</table>
