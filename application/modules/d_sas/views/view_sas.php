                                ...
                                <?php foreach (json_decode($data, true) as $x) : ?>
                                    <tr>
                                        ...
                                        <?php if (isset($x['satker'])) { ?>
                                            <td><a href="<?= base_url() . 'd_sas?biro=' . $x['satker']; ?>" class='btn btn-primary mr-1'><i class='fa fa-eye'></i></a></td>
                                            <!-- <td><a href="<?= base_url() . 'd_sas/' . $x['satker']; ?>" class='btn btn-primary mr-1'><i class='fa fa-eye'></i></a></td> -->
                                        <?php } else { ?>
