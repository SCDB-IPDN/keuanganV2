...
class D_sas_model extends CI_Model
{
    ...
    {
        $kampus = $this->db->query("SELECT tbl_satker.nama_satker, SUM(akun_sas.pagu) as pagu, SUM(akun_sas.realisasi) as realisasi FROM akun_sas JOIN tbl_satker ON tbl_satker.kode_satker = akun_sas.kode_satker ORDER BY akun_sas.kode_satker");
