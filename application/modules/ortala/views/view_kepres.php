			...
			<div class="panel panel-inverse">
				...
				<div class="table-responsive">
					...
					<tbody>
						...
						<table id="data-kepres" class="table table-striped table-bordered table-td-valign-middle" width="100%">
							<thead>
								<tr>
									<th>No</th>
									<th>KATEGORI</th>
...
$(document).ready(function() {
    ...
    var kepres_table = $('#data-kepres').DataTable({
		dom: 'lBfrtip',
        buttons: [
			{
				extend: 'copy',
