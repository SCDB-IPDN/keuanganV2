...
<div id="content" class="content">
	<ol class="breadcrumb float-xl-right">
    	...
    	<li class="breadcrumb-item"><a href="<?php echo base_url('ortala'); ?>">Peraturan Rektor</a></li>
	</ol>
			...
			<div class="panel panel-inverse">
				<div class="panel-heading">
					...
					<?php if($this->session->userdata('role') == 'Admin' || $this->session->userdata('role') == 'ortala'){?>
						<span><a href="" class="btn btn-sm btn-success" data-toggle="modal" data-target="#adduu">TAMBAH PERATURAN REKTOR</a></span>
