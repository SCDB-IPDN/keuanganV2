<div id="content" class="content">
  ...
  <!-- Modal ADD PNS -->
  <div class="modal fade" id="addpns" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Tambah PNS</h5>
        ...
        <div class="modal-body">
          <form action="kepegawaian/tambah_pns" method="POST">
            ...
            <div class="form-group">
              <div class="row">
                <div class="col-sm">
                  <label for="no_urut_pangkat" class="col-form-label">No Urut:</label>
                ...
                <div class="col-sm">
                  <label for="gol_ruang" class="col-form-label">Gol Ruang:</label>
                  <input type="text" class="form-control" id="gol_ruang" name="gol_ruang" placeholder="Gol Ruang.." required>
                </div>
                <div class="col-sm">
                  <label for="tmt_pangkat" class="col-form-label">TMT Pangkat:</label>
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-sm">
                  <label for="tmt_jabatan" class="col-form-label">TMT Jabatan:</label>
  ...
  ?>
  <!-- Modal EDIT PNS -->
  <div class="modal fade" id="editpns<?php echo $row->no;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
          <div class="modal-header">
  ...
  ?>
  <!-- Modal HAPUS PNS -->
  <div class="modal fade" id="hapuspns<?php echo $row->no;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
          <div class="modal-content">
              <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Hapus Data PNS</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
              </button>
              </div>
