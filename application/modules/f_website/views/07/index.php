<!-- SLIDER -->
<section class="hero">
    <video autoplay muted loop id="myVideo"><source src="<?= base_url('assets/video/video.mp4');?>" type="video/mp4">
                    ...
                    <div class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="<?= base_url('assets/logo/logo-pencil-one.png');?>" class="logo-kemendagri" alt="gambar">
                            </div>
                            <!-- <div class="carousel-item">
                                <img src="<?= base_url('assets/page-w7/images/demo-bg-2.png');?>" class="logo-ipdn" alt="gambar">
                            </div> -->
                        </div>
                    </div>
                </div>
...
<!-- LANDING 6 -->
<section class="section big-title-area parallax-off" style="background-image: url(assets/page-w7/upload/parallax_01.jpg);">
    <div class="container">
        <div class="parallax-desc text-center">
            <div class="row align-items-center">
                <div class="col-md-8 offset-md-2">
                    ...
                    <a href="//www.youtube.com/watch?v=3TC38Ao8h8o" data-lity class="playbutton"><i class="fa fa-play"></i> <small>IPDN Offical Video on Youtube</small></a>
                </div>
            </div>
        </div>
    </div>
...
<!-- LANDING 8 -->
<section class="section big-title-area parallax-off" style="background-image: url(assets/page-w7/upload/parallax_02.jpg);">
    <div class="container">
        <div class="parallax-desc text-center">
            <div class="row align-items-center">
                <div class="col-md-8 offset-md-2">
            ...
            <div class="instagram-widget-large clearfix">
                <div class="insta-box">
                    <a href="#">
                        ...
                        <img src="<?= base_url('assets/page-w7/upload/insta_01.jpg');?>" alt="" class="img-fluid">
                    </a>
                </div>
                <div class="insta-box">
                    <a href="#">
                        ...
                        <img src="<?= base_url('assets/page-w7/upload/insta_02.jpg');?>" alt="" class="img-fluid">
                    </a>
                </div>
                <div class="insta-box">
                    <a href="#">
                        ...
                        <img src="<?= base_url('assets/page-w7/upload/insta_03.jpg');?>" alt="" class="img-fluid">
                    </a>
                </div>
                <div class="insta-box">
                    <a href="#">
                        ...
                        <img src="<?= base_url('assets/page-w7/upload/insta_04.jpg');?>" alt="" class="img-fluid">
                    </a>
                </div>
                <div class="insta-box">
                    <a href="#">
                        ...
                        <img src="<?= base_url('assets/page-w7/upload/insta_05.jpg');?>" alt="" class="img-fluid">
                    </a>
                </div>
                <div class="insta-box">
                    <a href="#">
                        ...
                        <img src="<?= base_url('assets/page-w7/upload/insta_06.jpg');?>" alt="" class="img-fluid">
                    </a>
                </div>
                <div class="insta-box">
                    <a href="#">
                        ...
                        <img src="<?= base_url('assets/page-w7/upload/insta_07.jpg');?>" alt="" class="img-fluid">
                    </a>
                </div>
                <div class="insta-box">
                    <a href="#">
                        ...
                        <img src="<?= base_url('assets/page-w7/upload/insta_08.jpg');?>" alt="" class="img-fluid">
                    </a>
                </div>
                <div class="insta-box">
                    <a href="#">
                        ...
                        <img src="<?= base_url('assets/page-w7/upload/insta_09.jpg');?>" alt="" class="img-fluid">
                    </a>
                </div>
                <div class="insta-box">
                    <a href="#">
                        ...
                        <img src="<?= base_url('assets/page-w7/upload/insta_10.jpg');?>" alt="" class="img-fluid">
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-10 offset-md-1">
                <div id="testimonial_01" class="owl-carousel owl-theme owl-style-01">
                    <div class="testi-style-01 clearfix">    
                        <img src="<?= base_url('assets/page-w7/upload/team_01.jpg');?>" alt="" class="img-fluid rounded-circle float-left">
                    ...
                    <div class="testi-style-01 clearfix">    
                        <img src="<?= base_url('assets/page-w7/upload/team_02.jpg');?>" alt="" class="img-fluid rounded-circle float-left">
                    ...
                    <div class="testi-style-01 clearfix">    
                        <img src="<?= base_url('assets/page-w7/upload/team_03.jpg');?>" alt="" class="img-fluid rounded-circle float-left">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="service-style-01">
                    <img src="<?= base_url('assets/page-w7/upload/service_01.jpg');?>" alt="" class="img-fluid">
            ...
            <div class="col-md-4 mobmar30">
                <div class="service-style-01">
                    <img src="<?= base_url('assets/page-w7/upload/service_02.jpg');?>" alt="" class="img-fluid">
                    <div class="service-desc-01">
            ...
            <div class="col-md-4">
                <div class="service-style-01">
                    <img src="<?= base_url('assets/page-w7/upload/service_03.jpg');?>" alt="" class="img-fluid">
                    <div class="service-desc-01">
        ...
        <div class="row align-items-center">
            <div class="col-md-4">
                <div class="service-box text-center">
                    <img src="<?= base_url('assets/page-w7/images/icons/icon_01.png');?>" alt="" class="img-fluid">
                    <h4>Web Design</h4>
            ...
            <div class="col-md-4 mobmar30">
                <div class="service-box text-center">
                    <img src="<?= base_url('assets/page-w7/images/icons/icon_02.png');?>" alt="" class="img-fluid">
            ...
            <div class="col-md-4">
                <div class="service-box text-center">
                    <img src="<?= base_url('assets/page-w7/images/icons/icon_03.png');?>" alt="" class="img-fluid">
                    <h4>SEO Services</h4>
        ...
        <div class="row align-items-center">
            <div class="col-md-5">
                <div class="screen-normal wow slideInLeft">
                    <img src="<?= base_url('assets/page-w7/upload/device_02.png');?>" alt="" class="img-fluid">
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div id="works_01" class="owl-carousel owl-theme owl-style-02">
            <div class="owl-work-item">
                <div class="portfolio-ver-01">
                    <div class="media-element">
                        <img src="<?= base_url('assets/page-w7/upload/work_01.jpg');?>" alt="" class="img-fluid">
                    </div>
            ...
            <div class="owl-work-item">
                <div class="portfolio-ver-01">
                    <div class="media-element">
                        <img src="<?= base_url('assets/page-w7/upload/work_02.jpg');?>" alt="" class="img-fluid">
                    </div>
                    <div class="portfolio-details"> 
            ...
            <div class="owl-work-item">
                <div class="portfolio-ver-01">
                    <div class="media-element">
                        <img src="<?= base_url('assets/page-w7/upload/work_03.jpg');?>" alt="" class="img-fluid">
                    </div>
                    <div class="portfolio-details"> 
...
<section class="section">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-7">
                <div class="screen-normal wow slideInLeft">
                    <img src="<?= base_url('assets/page-w7/upload/screen_03.jpg');?>" alt="" class="img-fluid">
                </div>
            </div>
        ...
        <div class="row align-items-center">
            <div class="col-md-2 col-sm-6 col-xs-6">
                <div class="client-logo">
                    <a href="#"><img src="<?= base_url('assets/page-w7/upload/logo_01.png');?>" alt="" class="img-fluid"></a>
                </div>
            </div>
            <div class="col-md-2 col-sm-6 col-xs-6">
                <div class="client-logo">
                    <a href="#"><img src="<?= base_url('assets/page-w7/upload/logo_02.png');?>" alt="" class="img-fluid"></a>
                </div>
            </div>
            <div class="col-md-2 col-sm-6 col-xs-6">
                <div class="client-logo">
                    <a href="#"><img src="<?= base_url('assets/page-w7/upload/logo_03.png');?>" alt="" class="img-fluid"></a>
                </div>
            </div>
            <div class="col-md-2 col-sm-6 col-xs-6">
                <div class="client-logo">
                    <a href="#"><img src="<?= base_url('assets/page-w7/upload/logo_04.png');?>" alt="" class="img-fluid"></a>
                </div>
            </div>
            <div class="col-md-2 col-sm-6 col-xs-6">
                <div class="client-logo">
                    <a href="#"><img src="<?= base_url('assets/page-w7/upload/logo_05.png');?>" alt="" class="img-fluid"></a>
                </div>
            </div>
            <div class="col-md-2 col-sm-6 col-xs-6">
                <div class="client-logo">
                    <a href="#"><img src="<?= base_url('assets/page-w7/upload/logo_06.png');?>" alt="" class="img-fluid"></a>
                </div>
            </div>
        </div>
    </div>
