	...
	<div data-scrollbar="true" data-height="100%">
		...
		<ul class="nav">
			...
			<li class="<?php echo $this->uri->segment(1) == "d_span" || $this->uri->segment(1) == "d_pok" || $this->uri->segment(1) == "d_sas" || $this->uri->segment(2) == "biro" ? "active" : ""; ?> has-sub">
				...
				<ul class="sub-menu">
				<li class="<?php echo $this->uri->segment(1) == "d_span" || $this->uri->segment(2) == "serapan" ? "active" : ""; ?> has-sub">
						<a href="javascript:;">
							<b class="caret"></b>
							SPAN
						</a>
						<ul class="sub-menu">
							<li class="<?php echo $this->uri->segment(1) == "d_span" && $this->uri->segment(2) != "serapan" ? "active" : ""; ?>"><a href="<?php echo base_url('d_span'); ?>">UTAMA</a></li>
							<li class="<?php echo $this->uri->segment(2) == "serapan" ? "active" : ""; ?>"><a href="<?php echo base_url('d_span/serapan'); ?>">REALISASI</a></li>
						</ul>
					</li>
			...
			<li class="nav-header">Data</li>
				<li class="<?php echo $this->uri->segment(2)=="v_span" || $this->uri->segment(2)=="v_dosen" || $this->uri->segment(2)=="v_pok" || $this->uri->segment(2)=="v_sas" || $this->uri->segment(2)=="v_sarpras" || $this->uri->segment(2)=="v_praja" || $this->uri->segment(2)=="v_rank"?"active":"";?> has-sub">
					...
					<ul class="sub-menu">
						...
						<?php if($this->session->userdata('role') == 'Admin' || $this->session->userdata('role') == 'Keuangan' || $this->session->userdata('role') == 'Keuangan' ){?>
