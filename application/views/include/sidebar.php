		...
		<ul class="nav">
			...
			<li class="<?php echo $this->uri->segment(1) == "d_spanint" || $this->uri->segment(1) == "d_pok" || $this->uri->segment(1) == "d_sas" || $this->uri->segment(2) == "biro" ? "active" : ""; ?> has-sub">
				...
				<li class="<?php echo $this->uri->segment(1)=="d_sarpras" || $this->uri->segment(1)=="d_sarpras" && ($this->uri->segment(2)=="448302" || $this->uri->segment(2)=="677024" || $this->uri->segment(2)=="683091" || $this->uri->segment(2)=="683084" || $this->uri->segment(2)=="677010")?"active":"";?> has-sub">
					...
					<!-- PRESENSI -->
					<li class="<?php echo $this->uri->segment(1)=="absensi" || $this->uri->segment(2)=="absensi/users"?"active":"";?> has-sub">
						<a href="javascript:;">
							<b class="caret"></b>
						...
						<ul class="sub-menu">
							<li class="<?php echo $this->uri->segment(1)=="absensi" && $this->uri->segment(2)!="users" ?"active":"";?>"><a href="<?php echo base_url('absensi');?>">Rekap Presensi</a></li>
							<li class="<?php echo $this->uri->segment(2) == "users" ? "active" : ""; ?>"><a href="<?php echo base_url('absensi/users'); ?>">Tambah User</a></li>
