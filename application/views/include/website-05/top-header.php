<header class="mt-0 pt-0">
    <div class="bg-cover clearfix pt-3">
        ...
        <nav class="nav nav-fill mx-auto">
            <li class="nav-item">
                <a class="nav-link" href="https://facebook.com/fh5co" target="_blank">
                    ...
                    <li class="nav-item">
                        <form action="" method="POST">
                            <div class="input-group mt-0 mx-auto" style="width:16px;">
                                <div class="">
                                    <img src="assets/page-w5/images/search-icon.png" id="toggle-search" class="ml-2 toggle-search" alt="search icon">
                                </div>
                            </div>
                        </form>
                    </li>
...
<div class="row ml-0 mr-0">
    <div class="col-md-6 pr-0">
        <div class="card">
            <img class="card-img" src="assets/page-w5/images/left-img.jpg" alt="">
    ...
    <div class="col-md-6 pl-0">
        <div class="card">
            <img class="card-img" src="assets/page-w5/images/right-img.jpg" alt="">
            <div class="card-img-overlay d-flex align-items-center justify-content-center flex-column">
                <p>DECOR</p>
                <hr />
    ...
    <div class="col-md-3 pr-0 first">
        <div class="card">
            <img class="card-img" src="assets/page-w5/images/architecture.png" alt="">
    ...
    <div class="col-md-3 pl-0 pr-0">
        <div class="card">
            <img class="card-img" src="assets/page-w5/images/interior.png" alt="">
            <div class="card-img-overlay">
                <h5>Interior</h5>
            </div>
        </div>
    ...
    <div class="col-md-3 pl-0 pr-0">
        <div class="card">
            <img class="card-img" src="assets/page-w5/images/food.png" alt="">
            <div class="card-img-overlay">
                <h5>Food</h5>
            </div>
        </div>
    ...
    <div class="col-md-3 pl-0 last">
        <div class="card">
            <img class="card-img" src="assets/page-w5/images/travel.png" alt="">
            <div class="card-img-overlay">
                <h5>Travel</h5>
            </div>
        </div>
