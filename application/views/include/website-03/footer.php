          ...
          <div class="col-xl-3 col-lg-3 col-md-4 col-sm-8">
            <div class="single-footer-caption mb-50">
              <div class="footer-logo">
                <a href="index.php"><img src="assets/page-w3/img/logo/logo2_footer.png" class="lingkaran-footer" alt=""></a>
              </div>
            </div>
          </div>
...
<script src="assets/page-w3/js/vendor/modernizr-3.5.0.min.js"></script>
<script src="assets/page-w3/js/vendor/jquery-1.12.4.min.js"></script>
<script src="assets/page-w3/js/popper.min.js"></script>
<script src="assets/page-w3/js/bootstrap.min.js"></script>
<script src="assets/page-w3/js/jquery.slicknav.min.js"></script>
<script src="assets/page-w3/js/owl.carousel.min.js"></script>
<script src="assets/page-w3/js/slick.min.js"></script>
<script src="assets/page-w3/js/wow.min.js"></script>
<script src="assets/page-w3/js/animated.headline.js"></script>
<script src="assets/page-w3/js/jquery.magnific-popup.js"></script>
<script src="assets/page-w3/js/gijgo.min.js"></script>
<script src="assets/page-w3/js/jquery.nice-select.min.js"></script>
<script src="assets/page-w3/js/jquery.sticky.js"></script>
<script src="assets/page-w3/js/jquery.counterup.min.js"></script>
<script src="assets/page-w3/js/waypoints.min.js"></script>
<script src="assets/page-w3/js/jquery.countdown.min.js"></script>
<script src="assets/page-w3/js/contact.js"></script>
<script src="assets/page-w3/js/jquery.form.js"></script>
<script src="assets/page-w3/js/jquery.validate.min.js"></script>
<script src="assets/page-w3/js/mail-script.js"></script>
<script src="assets/page-w3/js/jquery.ajaxchimp.min.js"></script>
<script src="assets/page-w3/js/plugins.js"></script>
<script src="assets/page-w3/js/main.js"></script>
</body>
</html>