...
<footer class="footer section">
    <div class="container"> 
        <div class="row">
            <div class="col-md-4">
                <div class="widget">
                    <a href="index.php" title=""><img src="assets/page-w7/images/flogo.png" class="footer-logo" alt=""></a>
...
<script src="assets/page-w7/js/jquery.min.js"></script>
<script src="assets/page-w7/js/bootstrap.min.js"></script>
<script src="assets/page-w7/js/all.js"></script>
<script src="assets/page-w7/js/custom.js"></script>
</body>
</html>